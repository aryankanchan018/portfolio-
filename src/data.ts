...
export const PROJECTS: Project[] = [
  {
    ...
    github: 'https://github.com/aryankanchan',
...
export const ACHIEVEMENTS = [
  ...
  },
  {
    ...
    org: 'Google',
    desc: 'Completed the TensorFlow Developer Professional Certificate, demonstrating proficiency in building and training neural networks.',
    icon: '📜',
  ...
  },
  {
    ...
    org: 'IBM / Coursera',
    desc: 'Completed IBM\'s Python for Data Science and AI Development course with distinction.',
    icon: '🐍',
  ...
  },
  {
    ...
    org: 'Meta / Coursera',
    desc: 'Completed Meta\'s Front-End Developer Professional Certificate covering React, JavaScript, and modern web development.',
    icon: '⚛️',
  ...
  },
  {
    ...
    desc: 'Completed Andrew Ng\'s Machine Learning Specialization covering supervised, unsupervised, and reinforcement learning.',
    icon: '🤖',
...
export const SOCIAL = {
  github: 'https://github.com/aryankanchan',
  linkedin: 'https://linkedin.com/in/aryankanchan',
  email: 'aryan.kanchan@mituniversity.edu.in',
  instagram: 'https://instagram.com/aryankanchan',
